...
class PDFGenerator {
    ...
    static generateChartContainers(historicalData) {
        ...
        if (tempSeries.length > 0)
            html += '<div class="chart-container"><canvas id="temperatureChart" width="400" height="200"></canvas></div>';
        if (humSeries.length > 0)
            html += '<div class="chart-container"><canvas id="humidityChart" width="400" height="200"></canvas></div>';
        if (pressureSeries.length > 0)
            html += '<div class="chart-container"><canvas id="pressureChart" width="400" height="200"></canvas></div>';
        return html;
    }
    /**
